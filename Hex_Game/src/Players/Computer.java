...
public class Computer implements Player {
	...
	/**
	 * Sets up the default configuration of Computer
	 */
	public Computer() {
	...
	/**
	 * Constructor for Computer Tree Search player
	 ...
	 */
	public Computer(float aUCTCoeficient, int aTimeout, int aCountout, boolean swapping) {
